...
Requires: %{?scl_prefix}libuv-devel %{?scl_prefix}http-parser-devel openssl-devel %{?scl_prefix}c-ares-devel zlib-devel v8314-v8-devel
...
* Wed Jun 24 2015 Tomas Hrcka <thrcka@redhat.com> - 0.10.39-1
- Rebase to latest upstream release
...
* Thu Dec 05 2013 Tomas Hrcka <thrcka@redhat.com> - 0.10.22-1.1
- rebuilt with new libuv
